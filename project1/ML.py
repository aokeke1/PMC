...
print ("(len(train_labels),len(val_labels),len(test_labels))",(len(train_labels),len(val_labels),len(test_labels)))
...
#    
#    pkl.dump(thetas,open(ext+"thetas"+str(fileNumLabel)+".p","wb"))